...
export declare type SelectOnChange = (value: Option | Option[], change?: {
...
export declare function useSelect({ create, single, disabled, selectionVisibleIn, getDebounce, getOption, stateReducer, filterFn, scrollToIndex, shiftAmount, duplicates, options, value, onChange, placement, placeholder, searchPlaceholder, }: UseSelectProps): UseSelectReturn;
